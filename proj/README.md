...
- Mantenha **Confirm email** habilitado em `Authentication > Providers > Email`.
- Para enviar confirmações a qualquer pessoa, configure um servidor em `Authentication > SMTP Settings`.
- O serviço padrão do Supabase é apenas para testes, restringe destinatários e possui limite baixo de envio.
- A tela de entrada oferece **Reenviar confirmação** e mostra erros de SMTP ou limite de envio.
